...
- [Aerobase Concierge VPS demo](https://github.com/kurosh87/aerobase-concierge-vps-demo)
...
- Aerobase Concierge VPS demo: public-safe infrastructure demo prepared separately as `aerobase-concierge-vps-demo`. It shows dry-run VPS provisioning, DNS setup, cloud-init bootstrap shape, and OpenClaw travel-agent runtime events for air-travel research, booking management, award redemption strategy, jetlag recovery scheduling, calendar coordination, and knowledge-graph-backed recommendations without exposing real provider keys or private runtime code.
