...
export const WorkflowIllustration = () => {
    return (
        <div
            aria-hidden
            className="max-w-2xs min-w-2xs relative mx-auto">
            <div>
                <div className="ring-border-illustration shadow-black/6.5 bg-illustration flex items-center gap-2 rounded-xl p-3 shadow-md ring-1">
