...
function NavigationMenuContent({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Content>) {
    return (
        <NavigationMenuPrimitive.Content
            ...
            className={cn(
                'left-0 top-0 w-full origin-top p-2 pr-2.5 md:absolute md:w-auto',
...
function NavigationMenuLink({ className, render, children, ...props }: NavigationMenuLinkProps) {
    ...
    if (render) {
        ...
        return React.cloneElement(render as React.ReactElement<any>, {
            className: cn(linkClassName, renderProps.className as string | undefined),
            children,
        })
    }
    return (
