...
const links = [
    {
        ...
        items: [
            ...
            {
                title: 'Dashboard',
                href: 'https://dashboard.reala.agency',
            },
        ],
    },
    {
        ...
        items: [
            ...
            {
                title: 'Contact',
                href: 'mailto:support@reala.agency',
            },
        ],
    },
]
            ...
            <div className="mx-auto max-w-6xl space-y-16 px-6">
                <div className="grid gap-12 md:grid-cols-5">
                    <div className="space-y-6 md:col-span-2 md:space-y-12">
                        ...
                        <p className="text-muted-foreground text-balance text-sm">Reala helps real estate teams follow up with leads, coordinate appointments, and keep conversations moving.</p>
                    </div>
